...
public class ScanActivity extends Activity {
    ...
    private ScanAdapter bluetoothLeScanResultAdapter =
            new ScanAdapter(bluetoothLeScanResultList,
                    new ScanAdapter.OnItemClickListener() {
                        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout constraintLayout = findViewById(R.id.scan_main_layout);
        ...
        Toast.makeText(this, "Welcome to SmartSole!", Toast.LENGTH_LONG).show();
    }
